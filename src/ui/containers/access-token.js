    ...
    return (
      <div>
        ...
        <div style={styles.buttons}>
          <button style={styles.saveButton} className="ui primary button" onClick={this.handleOnClickSave}>
            <i className="save icon"></i>
            Save
          </button>
        </div>
        <div style={styles.footer}>
          <a href={GITLAB_URL_PERSONAL_TOKEN} title={GITLAB_URL_PERSONAL_TOKEN}>
